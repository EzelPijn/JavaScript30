  // Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      console.log(inventorsFullName);
            ...
            const inventorsFullName = inventors.map(function getFullName(item){
              return [item.first, item.last].join(" ");
            });

            Refactoring of Above with => function
            const inventorsFullName = inventors.map(item => [item.first, item.last].join(" "));
            
            Refactoring of Above to remove const
            console.log(inventors.map(item => [item.first, item.last].join(" ")));
            */
      ...
      const inventorsBirthdate = inventors.sort(birthdate);
